...
public class ejercicio04 {
	...
	public static void main(String[] args) {
		...
		int num3 = Integer.parseInt(var3);// Se crea una variable "num3" en la que se introduce var3 transformada en número entero
		String var4 = JOptionPane.showInputDialog("Introduzca un número: ");// Se crea una variable "var4" y se guarda un dato
		int num4 = Integer.parseInt(var4);// Se crea una variable "num4" en la que se introduce var4 transformada en número entero
		String var5 = JOptionPane.showInputDialog("Introduzca un número: ");// Se crea una variable "var5" y se guarda un dato
		int num5 = Integer.parseInt(var5);// Se crea una variable "num5" en la que se introduce var5 transformada en número entero
