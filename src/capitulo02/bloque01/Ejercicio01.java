...
public class Ejercicio01 {
	...
	public static void main(String[] args) {
		...
		if (num1 <= num2) { // Si el num1 es menor que num2, realiza lo que esta entre corchetes
			System.out.println("El número mayor es: " + num2);// Se imprime el num2 ya que es mayor que num1
		}
		else {
			if (num1 >= num2) {// Si el num1 es mayor que num2, realiza lo que esta entre corchetes
				System.out.println("El número mayor es: " + num1);// Se imprime el num1 ya que es mayor que num2
			}
		}
	}
