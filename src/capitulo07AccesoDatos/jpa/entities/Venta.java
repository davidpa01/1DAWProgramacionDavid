package capitulo07AccesoDatos.jpa.entities;
...
public class Venta implements Serializable {
	...
	public String toString() {
		return "Venta [id=" + id + ", idCliente=" + cliente.getId() + ", idConcesionario=" + concesionario.getId() + ", idCoche="
				+ coche.getId() + ", fecha=" + fecha + ", precioVenta=" + precioVenta + "]";
	}
